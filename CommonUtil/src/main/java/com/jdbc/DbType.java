...
public enum DbType {
	/**
	 * 摘要: 非 Unicode 字符的可变长度流，范围在 1 到 8,000 个字符之间。 *
	 */
	AnsiString,
	/**
	* 摘要:
	...
	* */
	...
	/**
	* 摘要:
	* 货币值，范围在 -2 63（即 -922,337,203,685,477.5808）到 2 63 -1（即
	* +922,337,203,685,477.5807）之间，精度为千分之十个货币单位。
	* */
	Currency,
/**
	* 摘要:
